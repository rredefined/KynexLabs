    ...
    return (
      <div className="fixed inset-0 bg-black flex items-center justify-center">
        <div className="relative">
          <div className="text-6xl font-bold text-white animate-pulse tracking-widest">IRIS</div>
      ...
      <nav className="fixed w-full top-0 z-50 bg-black/30 backdrop-blur-md border-b border-white/5">
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="flex justify-between items-center h-20">
            <Link href="/" className="text-2xl font-bold tracking-wider group">
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-fuchsia-500 group-hover:from-fuchsia-500 group-hover:to-violet-500 transition-all duration-500">IRIS</span>
            </Link>
            ...
            <div className="hidden lg:flex items-center space-x-8">
              ...
              <Link href="#" className="nav-link">Email</Link>
              <Link href="#" className="nav-link">Security</Link>
              <Link href="#" className="nav-link">Explore all</Link>
              ...
              <div className="flex items-center space-x-6 ml-8 border-l border-white/10 pl-8">
                ...
                <Link href="#" className="text-sm hover:text-violet-400 transition-colors">Sign in</Link>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className={`lg:hidden ${menuOpen ? 'block' : 'hidden'} bg-black/95 backdrop-blur-lg border-t border-white/5`}>
          <div className="px-6 py-4 space-y-4">
            <Link href="#" className="block text-lg text-white/70 hover:text-white">Domains</Link>
            <Link href="#" className="block text-lg text-white/70 hover:text-white">Hosting</Link>
            <Link href="#" className="block text-lg text-white/70 hover:text-white">Email</Link>
            <Link href="#" className="block text-lg text-white/70 hover:text-white">Security</Link>
            <Link href="#" className="block text-lg text-white/70 hover:text-white">Explore all</Link>
            <Link href="#" className="block text-lg text-white/70 hover:text-white">Sign in</Link>
          </div>
        </div>
      </nav>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="relative z-10 text-center lg:text-left">
              <div className="inline-block">
                <p className="text-sm font-medium mb-4 bg-gradient-to-r from-violet-500 to-fuchsia-500 text-transparent bg-clip-text">IRIS™</p>
            ...
            <div className="relative bg-black/40 backdrop-blur-sm rounded-3xl p-10 border border-white/5 group-hover:border-violet-500/30 transition-colors">
              <div className="flex flex-col lg:flex-row gap-8 items-center">
                ...
                <div className="lg:w-2/3">
                  <div className="text-2xl font-medium mb-4">"The performance and reliability of IRIS's infrastructure have been game-changing for our business. Their support team is exceptional."</div>
            ...
            <div className="col-span-2">
              <div className="mb-8">
                <Link href="/" className="text-3xl font-bold tracking-wider inline-block">
                  <span className="bg-clip-text text-transparent bg-gradient-to-r from-violet-500 to-fuchsia-500">IRIS</span>
                </Link>
